...
Utilitário open source de treinamento, pensado para ensinar os prováveis casos de abuso de um fluxo sob diferentes perspectivas — para os vários times da esteira de ideação e desenvolvimento de produtos, processos e fluxos. No papel, antes do primeiro commit.
